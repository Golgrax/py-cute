    ...
    with doc.add(div(_class='mobile-view')) as mobile_view_div:
        with mobile_view_div.add(div(_class='content-wrapper')):
            ...
            with form(method='post'):
                ...
                button(img(src=url_for('static', filename='assets/register_button.png'), alt='Register'), type='submit', style="border:none; background:transparent; padding:0; cursor:pointer;")
                br()
    ...
    with doc.add(div(_class='mobile-view')) as mobile_view_div:
        with mobile_view_div.add(div(_class='content-wrapper')):
            ...
            with form(method='post'):
                ...
                div(label("Password:", fr="password"), input_(type="password", name="password", id="password", required=True), _class="form-group")
                button(img(src=url_for('static', filename='assets/login_button.png'), alt='Log In'), type='submit', style="border:none; background:transparent; padding:0; cursor:pointer;")
                br()
