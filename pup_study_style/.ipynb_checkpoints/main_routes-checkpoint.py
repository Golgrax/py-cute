        ...
        with mobile_view_div.add(div(_class='content-wrapper')):
            ...
            if product:
                with div(_class="product-card", style="text-align:center;"):
                    div(img(src=url_for('static', filename=product['image_url']), alt=product['name'], style="max-width:80%; height:auto; margin-bottom:10px; border: 1px solid #ccc;"), _class="product-image-container")
                    h3(product['name'], style="font-size: 1.2em; margin-bottom: 5px;")
                    div(
                        img(src=url_for('static', filename='assets/PUPBaybayinLace_advert.png'), alt="PUP Baybayin Lace Advert", style="max-width: 100%; height: auto;"),
            ...
            if all_products:
                for p_item in all_products:
                    with div(_class="product-card"):
                        img(src=url_for('static', filename=p_item['image_url']), alt=p_item['name'], _class="product-image")
    ...
    with doc.add(div(_class='mobile-view')) as mobile_view_div:
        with mobile_view_div.add(div(_class='content-wrapper')):
            ...
            div(
                ...
                a("BUY NOW", href=url_for('main.checkout_page'),
